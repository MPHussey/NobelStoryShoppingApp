...
<head>
    ...
    <title>Nobel Story | Contact Us</title>
                ...
                <div class="get-in-touch-wrap">
                    ...
                    <div class="contact-from contact-shadow">
                        <form id="contact-form">
                            <div class="row">
                                <div class="col-lg-6">
                                    <input name="clientName" type="text" placeholder="Name" required>
                                </div>
                                <div class="col-lg-6">
                                    <input name="clientEmail" type="email" placeholder="Email" required>
                                </div>
                                <div class="col-lg-12">
                                    <input name="clientSubject" type="text" placeholder="Subject" required>
                                </div>
                                <div class="col-lg-12">
                                    <textarea required name="clientMessage" placeholder="Your Message"></textarea>
                                </div>
                                <div class="col-lg-12">
...
============================================ -->
    ...
    <script src="assets/js/pageScripts/contact.js"></script>

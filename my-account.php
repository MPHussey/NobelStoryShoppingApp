...
<head>
    ...
    <title>Nobel Story | My Account</title>
                                        ...
                                        <div class="tab-pane fade show active" id="account-info" role="tabpanel">
                                            <div class="myaccount-content">
                                                <div style="position: relative;">
                                                    <span class="btn-account-details-update" style="position: absolute;right:0;color:#ff5151;cursor:pointer">Update Details</span>
...
" id="btn-modal-close" type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <script src="assets/js/pageScripts/my-account.js"></script>
</body>

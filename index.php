...
<body>
    <div class="main-wrapper">
            ...
            <div class="row align-items-center g-0">
                <div class="col-lg-6 col-md-6 col-12 col-sm-12">
                    <div class="slider-content-4 ml-150">
                        <h1 class="wow fadeInLeft col-md-6 col-sm-12">Best Gem in Sri Lanka</h1>
        ...
        <div class="feature-area pb-110 section-padding-3">
                ...
                <div class="product-slider-active-2 ">
                    ...
                    <!-- <div class="product-wrap product-border-2 pro-hover-shadow mb-40">
                        ...
                        <div class="product-content-2">
                            <h4><a href="product-details.html">Simple Gem</a></h4>
                ...
                <div class="banner-pattern-wrap">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="banner-wrap mb-30">
                                <a href="product-details.html">
                                    <img src="assets/images/banner/770x520.jpg" alt="banner">
                                </a>
                                <div class="banner-content-5">
                                    <div class="banner-title-img">
                                        <!-- <div class="banner-img">
                                            <img src="assets/images/banner/work-author-1.png" alt="work-author">
                                        </div> -->
                                    ...
                                    <!-- <div class="banner-zoom">
                                        <a class="img-popup" href="assets/images/banner/770x520.jpg"><i class="la la-search-plus"></i></a>
                                    </div> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <div class="discount-content mt-5">
                            ...
                            <!-- <div class="banner-wrap mb-30">
                                <a href="product-details.html">
                                    <img src="assets/images/banner/370x247.jpg" alt="banner">
                                </a>
                                <div class="banner-content-5">
                                    <div class="banner-title-img">
                                        <div class="banner-img">
                                            <img src="assets/images/banner/work-author-2.png" alt="work-author">
                                        </div>
                                        <div class="banner-title">
                                            <h4>Popular Gem Type</h4>
                                        </div>
                                    </div>
                                    <div class="banner-zoom">
                                        <a class="img-popup" href="assets/images/banner/370x247.jpg"><i class="la la-search-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="banner-wrap mb-30">
                                ...
                                <div class="banner-content-5">
                                    <div class="banner-title-img">
                                        <div class="banner-img">
                                            <img src="assets/images/banner/work-author-3.png" alt="work-author">
                                        </div>
                                        <div class="banner-title">
                                            <h4>Most Selling Gem Type</h4>
                                        </div>
                                    </div>
                                    <div class="banner-zoom">
                                        <a class="img-popup" href="assets/images/banner/370x247.jpg"><i class="la la-search-plus"></i></a>
        ...
        <div class="product-area pb-60 mt-5">
            <div class="container">
                ...
                <div id="all-products-home" class="row">

                    <!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="product-wrap mb-35">
                            <div class="product-img mb-15">
                              
                                <img src="assets/images/product-details/800x800.jpg"
                                alt="product">
                                <div class="product-action-3">

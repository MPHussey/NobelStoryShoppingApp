...
<head>
    ...
    <title>Nobel Story | About us</title>
...
<body>
    <div class="main-wrapper">
        ...
        <div class="breadcrumb-area bg-img" style="background-image:url(assets/images/slider/1.jpg);">
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <h2 style="color:white">About us page</h2>
                    <!-- <ul>
                        <li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="banner-wrap mb-30">
                            <a href="product-details.html"><img src="assets/images/banner/banner-16.png" alt="banner"></a>
        ...
        <!-- <div class="brand-logo-area pb-90">
            <div class="container">
